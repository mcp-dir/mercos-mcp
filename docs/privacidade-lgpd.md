...
Mercos segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Mercos** | BR | ERP de vendas, provedor dos dados do usuário |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [mercos@mcp.ai](mailto:mercos@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
